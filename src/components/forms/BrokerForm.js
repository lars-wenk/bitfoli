...
class BrokerForm extends React.Component {
  state = {
    data: {
      brokerid: this.props.broker.brokerid,
      title: this.props.broker.title,
      auth: this.props.broker.auth,
      secure: this.props.broker.secure,
      pages: this.props.broker.pages
    },
    covers: this.props.broker.covers,
    index: 0,
    loading: false,
    errors: {}
  };
            ...
            <Grid.Row>
              <Grid.Column>
                <Form.Field error={!!errors.title}>
                  <label htmlFor="title">Broker Title</label>
                  <input
                    type="text"
                    id="title"
                    name="title"
                ...
                <Form.Field error={!!errors.authors}>
                  <label htmlFor="authors">Broker Authors</label>
                  <input
                    type="text"
                    id="authors"
                    name="authors"
